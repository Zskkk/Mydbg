...
public class AndroidRelocationIterator implements Iterator<MemoizedObject<ElfRelocation>> {
    ...
    //private static final Log log = LogFactory.getLog(net.fornwall.jelf.AndroidRelocationIterator.class);
    ...
    private long readSleb128() {
        return readSignedLeb128(buffer, objectSize == ElfFile.CLASS_32 ? 32 : 64);
    }
